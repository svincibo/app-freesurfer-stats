...
whole_brain = whole_brain.reindex(columns=['subjectID','Total Brain Volume','Total Intracranial Volume','Total Cortical Gray Matter Volume','Total White Matter Volume','Left Hemisphere Cortical Gray Matter Volume','Right Hemisphere Cortical Gray Matter Volume','Left Hemisphere White Matter Volume','Right Hemisphere White Matter Volume','Left Hemisphere Mean Cortical Gray Matter Thickness','Right Hemisphere Mean Cortical Gray Matter Thickness'],inplace=True)
